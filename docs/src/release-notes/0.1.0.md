...
## sgcore
* Move ExtendedBigDecimal to sgcore/format, make use of it in formatting functions by @drinkcat in https://github.com/uutils/coreutils/pull/7458
* sgcore: format: num_format: add `fmt` function tests, and workaround 0e10 printing. by @drinkcat in https://github.com/uutils/coreutils/pull/7514
* sgcore: format: num_parser: Use ExtendedBigDecimal by @drinkcat in https://github.com/uutils/coreutils/pull/7556
* sgcore: format: Collection of small parser fixes by @drinkcat in https://github.com/uutils/coreutils/pull/7623
* seq: Move to sgcore/format common number parsing code by @drinkcat in https://github.com/uutils/coreutils/pull/7624
* sgcore: Move extendedbigdecimal and parsers to 2 separate features by @drinkcat in https://github.com/uutils/coreutils/pull/7647
* sgcore: Minor fix to optional dependences by @RenjiSann in https://github.com/uutils/coreutils/pull/7654
* sgcore: format: Fix hexadecimal default format print by @drinkcat in https://github.com/uutils/coreutils/pull/7631
* sgcore: num_parser: Limit precision when computing 2**exp by @drinkcat in https://github.com/uutils/coreutils/pull/7712
* sgcore: add `chrono` to `uptime` feature by @cakebaker in https://github.com/uutils/coreutils/pull/7719
* sgcore/quoting_style: Add support for quoting/escaping empty strings by @sargas in https://github.com/uutils/coreutils/pull/7693
* fix(sleep): use sgcore's from_str to support parsing hex by @Qelxiros in https://github.com/uutils/coreutils/pull/7675
* cp: factor make_fifo() function out to sgcore::fs by @jfinkels in https://github.com/uutils/coreutils/pull/7775
* sgcore: num_parser: Operate on slices, instead of iterator by @drinkcat in https://github.com/uutils/coreutils/pull/7790
* Move seq's `fast_inc` to `sgcore`, use it in `cat` by @drinkcat in https://github.com/uutils/coreutils/pull/7782
* Allow compiling `sgcore` with `wasm32-unknown-unknown` by @cptpiepmatz in https://github.com/uutils/coreutils/pull/7840
* sgcore: add safe wrapper for getpgrp() by @eduardorittner in https://github.com/uutils/coreutils/pull/7676
* sgcore/echo:handle ControlFlow result by @alexs-sh in https://github.com/uutils/coreutils/pull/7881
* selinux: use the sgcore::selinux::is_selinux_enabled() function by @sylvestre in https://github.com/uutils/coreutils/pull/7909
* sgcore: add functions to manage translations by @sylvestre in https://github.com/uutils/coreutils/pull/7955
