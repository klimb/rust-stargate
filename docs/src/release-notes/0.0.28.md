...
* sgcore: Split `tty` from `proc_info` by @Krysztal112233 in https://github.com/uutils/coreutils/pull/6593
* sgcore: Fix return value of `ProcessInfomation::tty` by @Krysztal112233 in https://github.com/uutils/coreutils/pull/6597
* sgcore: Add `getsid` for `process.rs` by @Krysztal112233 in https://github.com/uutils/coreutils/pull/6600
* fsext: remove crash! by @Kev1n8 in https://github.com/uutils/coreutils/pull/6549
* sgcore+timeout: accept signals of any casing by @BenWiederhake in https://github.com/uutils/coreutils/pull/6382
* sgcore: Move `pgrep/process.rs` to `sgcore` by @Krysztal112233 in https://github.com/uutils/coreutils/pull/6483
* sgcore/proc_info: ignore spelling of some words by @cakebaker in https://github.com/uutils/coreutils/pull/6561
* sgcore: fix "unused import" warning on Redox by @cakebaker in https://github.com/uutils/coreutils/pull/6695
* sgcore/checksum: simplify `determine_regex()` by @cakebaker in https://github.com/uutils/coreutils/pull/6500
* sgcore: allow use of deprecated `PanicInfo` by @cakebaker in https://github.com/uutils/coreutils/pull/6792
* sgcore: disable default signal-handlers added by Rust by @Ecordonnier in https://github.com/uutils/coreutils/pull/6806
...
* doc: add and change documentation of sgcore by @Its-Just-Nans in https://github.com/uutils/coreutils/pull/6551
* document sgcore::Args #5068 by @Its-Just-Nans in https://github.com/uutils/coreutils/pull/6515
