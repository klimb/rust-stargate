...
## sgcore
* sgcore/safe_traversal: remove unnecessary vars by @cakebaker in https://github.com/uutils/coreutils/pull/8627
...
* sgcore/checksum: use `ChecksumError` variants by @cakebaker in https://github.com/uutils/coreutils/pull/8636
* sgcore/selinux: add support for translations by @sylvestre in https://github.com/uutils/coreutils/pull/8628
* sgcore/checksum: improve API of `create_sha3()` by @cakebaker in https://github.com/uutils/coreutils/pull/8645
* sgcore: parse_time: avoid expensive `with_scale(9)` for huge inputs by @loskutov in https://github.com/uutils/coreutils/pull/8740
* sgcore: fix clippy warnings by @bakanovskii in https://github.com/uutils/coreutils/pull/8769
* sgcore/fsext: recognize magic number for `cgroup2fs` by @cakebaker in https://github.com/uutils/coreutils/pull/8778
* sgcore: handle situation using numberic username by @zhw2101024 in https://github.com/uutils/coreutils/pull/7788
* sgcore/parse_time: return 1ns for small numbers by @cakebaker in https://github.com/uutils/coreutils/pull/8821
* sgcore: ringbuffer pre-allocates memory based on size given by @asder8215 in https://github.com/uutils/coreutils/pull/8895
* refactor(sgcore): integrate procfs for Linux memory parsing by @mattsu2020 in https://github.com/uutils/coreutils/pull/8951
...
* bench: call the function directly to improve the profiling + move the common functions in sgcore by @sylvestre in https://github.com/uutils/coreutils/pull/8716
...
* clippy: add missing `[lints] workspace = true` to `sgcore/Cargo.toml` by @cakebaker in https://github.com/uutils/coreutils/pull/8771
