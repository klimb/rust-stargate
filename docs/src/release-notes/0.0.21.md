...
### cp
* `cp`: re-export `sgcore::{BackupMode, UpdateMode}` by @tertsdiepraam in https://github.com/uutils/coreutils/pull/5211
...
### Build system & CI
* sgcore: make deps of "sum" feature optional by @cakebaker in https://github.com/uutils/coreutils/pull/5227
* sgcore: make "dunce" optional by @cakebaker in https://github.com/uutils/coreutils/pull/5229
* sgcore: turn backup_control into a feature by @cakebaker in https://github.com/uutils/coreutils/pull/5231
* sgcore: turn ranges into a feature by @cakebaker in https://github.com/uutils/coreutils/pull/5238
* sgcore: turn update_control into a feature by @cakebaker in https://github.com/uutils/coreutils/pull/5232
...
* sgcore: use "workspace=true" for some dependencies by @cakebaker in https://github.com/uutils/coreutils/pull/5110
...
* sgcore: remove unnecessary heap allocation by @thechampagne in https://github.com/uutils/coreutils/pull/5228
...
* sgcore: don't show error for ambiguous value by @cakebaker in https://github.com/uutils/coreutils/pull/5127
* sgcore: provide capacity for vectors by @shinhs0506 in https://github.com/uutils/coreutils/pull/5086
* use is_empty() in mv & rmdir by @shinhs0506 in https://github.com/uutils/coreutils/pull/5117
* Extract sgcore::line_ending::LineEnding by @simon04 in https://github.com/uutils/coreutils/pull/5120
* sgcore,comm: fix warnings from bool_to_int_with_if by @cakebaker in https://github.com/uutils/coreutils/pull/5206
