...
### echo
* use sgcore::format::parse_escape_only() by @jfinkels in https://github.com/uutils/coreutils/pull/7316
...
### uptime
* refactor, move some codes to sgcore by @Bluemangoo in https://github.com/uutils/coreutils/pull/7289
...
* sgcore/docs.rs: generate the doc for all features by @sylvestre in https://github.com/uutils/coreutils/pull/7220
