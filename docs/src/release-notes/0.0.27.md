...
* src/sgcore/src/lib/features/fsext.rs: Add magic for bcachefs by @phedders in https://github.com/uutils/coreutils/pull/6438
* tests: remove all `#[cfg(not(target_pointer_width = "128"))]` by @cakebaker in https://github.com/uutils/coreutils/pull/6418
* Cargo.toml: enable sgcore's `mode` feature by @cakebaker in https://github.com/uutils/coreutils/pull/6421
* sgcore: remove support for Bitrig by @cakebaker in https://github.com/uutils/coreutils/pull/6383
