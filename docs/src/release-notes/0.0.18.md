...
* Replace sgcore::parse_time::from_str with fundu by @Joining7943 in https://github.com/uutils/coreutils/pull/4448
...
* `tail`: Cargo.toml: Remove unneeded features of sgcore and the nix dependency by @Joining7943 in https://github.com/uutils/coreutils/pull/4376
...
### sgcore
* util: fix publish order of sgcore_procs and sgcore by @tertsdiepraam in https://github.com/uutils/coreutils/pull/4287
* `sgcore`: Fix #4298: Fails to build on s390x (and riscv64) by @Joining7943 in https://github.com/uutils/coreutils/pull/4299
* parser: fix index out of bounds error by @papparapa in https://github.com/uutils/coreutils/pull/4484
* sgcore: fix help section doesn't render 3+ level headers by @piotrkwiecinski in https://github.com/uutils/coreutils/pull/4569
* Fix panic in multi-byte characters by @howjmay in https://github.com/uutils/coreutils/pull/4388
* sgcore_procs: extract "about" and "usage" info from new help structure by @cakebaker in https://github.com/uutils/coreutils/pull/4385
* sgcore: indent multiline usage info by @cakebaker in https://github.com/uutils/coreutils/pull/4393
