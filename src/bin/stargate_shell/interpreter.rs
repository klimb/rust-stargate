        ...
        match expr {
            ...
            Expression::MethodCall { object, method, args } => {
                ...
                match obj_value {
                    ...
                    Value::Set(mut set) => {
                        // Handle set built-in methods (Rust HashSet-style)
                        match method.as_str() {
                            // Core methods
                            "insert" | "add" => {
                                if args.len() != 1 {
                            ...
                            "union" => {
                                ...
                                let other = self.eval_expression(args[0].clone())?;
                                match other {
                                    Value::Set(other_set) => {
                                        let result: std::collections::HashSet<_> = set.union(&other_set).cloned().collect();
                                        Ok(Value::Set(result))
                                    }
                            ...
                            "intersection" => {
                                ...
                                match other {
                                    Value::Set(other_set) => {
                                        let result: std::collections::HashSet<_> = set.intersection(&other_set).cloned().collect();
                                        Ok(Value::Set(result))
                                    }
                            ...
                            "difference" => {
                                ...
                                match other {
                                    Value::Set(other_set) => {
                                        let result: std::collections::HashSet<_> = set.difference(&other_set).cloned().collect();
                                        Ok(Value::Set(result))
                                    }
                            ...
                            "symmetric_difference" => {
                                ...
                                match other {
                                    Value::Set(other_set) => {
                                        let result: std::collections::HashSet<_> = set.symmetric_difference(&other_set).cloned().collect();
                                        Ok(Value::Set(result))
                                    }
